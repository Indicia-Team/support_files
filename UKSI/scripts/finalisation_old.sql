...
select
o.id, t.id as taxon_id, t.taxon,  t.search_code, o.taxa_taxon_list_id, cttl.id as new_taxa_taxon_list_id
...
update indicia.cache_occurrences_functional o set taxa_taxon_list_id=tf.new_taxa_taxon_list_id
from to_fix tf where tf.id=o.id;

-- Ensure occurrence cache taxonomy info is correct.
UPDATE indicia.cache_occurrences_functional o
SET
