...
update import.survey_attribute_values u1
  set int_value=u2.id
  from import.termlists u2, import.survey_attributes a
...
update import.sample_attribute_values u1
  set int_value=u2.id
  from import.termlists u2, import.sample_attributes a
  where u1.int_value=u2.old_id
  and u1.int_value<>u2.id
...
update import.occurrence_attribute_values u1
  set int_value=u2.id
  from import.termlists u2, import.occurrence_attributes a
  where u1.int_value=u2.old_id
  and u1.int_value<>u2.id
...
update import.location_attribute_values u1
  set int_value=u2.id
  from import.termlists u2, import.location_attributes a
  where u1.int_value=u2.old_id
  and u1.int_value<>u2.id
...
update import.person_attribute_values u1
  set int_value=u2.id
  from import.termlists u2, import.person_attributes a
  where u1.int_value=u2.old_id
  and u1.int_value<>u2.id
...
update import.taxa_taxon_list_attribute_values u1
  set int_value=u2.id
  from import.termlists u2, import.taxa_taxon_list_attributes a
  where u1.int_value=u2.old_id
  and u1.int_value<>u2.id
