...
select distinct on (a.id) a.* into export.survey_attributes
...
select distinct on (a.id) a.* into export.sample_attributes
...
select distinct on (a.id) a.* into export.occurrence_attributes
...
select distinct on (a.id) a.* into export.location_attributes
...
select distinct on (a.id) a.* into export.person_attributes
...
select distinct on (a.id) a.* into export.taxa_taxon_list_attributes
