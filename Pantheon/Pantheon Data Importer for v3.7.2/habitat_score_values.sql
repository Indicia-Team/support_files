...
('ERS (D, G, H & P)', '1', 'total'),
('ERS (D, G, H & P)', '2', 'high'),
('ERS (D, G, H & P)', '3', 'moderate'),
('ERS (D, G, H & P)', '4', 'wetland'),
('ERS (D, G, H & P)', '5', 'tourist'),
('seepage habitats fidelity score - woodland', 'A', ''),
('seepage habitats fidelity score - woodland', 'B', ''),
('seepage habitats fidelity score - woodland', 'C', ''),
