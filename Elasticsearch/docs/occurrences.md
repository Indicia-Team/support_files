...
PUT occurrence_brc1_v1
{
  ...
  "mappings": {
    ...
    "properties": {
      "id": { "type": "integer" },
      "@timestamp": { "type": "date"},
      "dna_derived_data.associated_sequences": { "type": "keyword" },
      "dna_derived_data.dna_sequence": { "type": "keyword", "index": false },
      "dna_derived_data.target_gene": { "type": "keyword" },
      "dna_derived_data.env_medium": { "type": "keyword" },
      "dna_derived_data.env_broad_scale": { "type": "keyword" },
      "dna_derived_data.otu_db": { "type": "keyword" },
      "dna_derived_data.otu_seq_comp_appr": { "type": "text" },
      "dna_derived_data.otu_class_appr": { "type": "text" },
      "dna_derived_data.dna_env_local_scale": { "type": "keyword" },
      "dna_derived_data.target_subfragment": { "type": "keyword" },
      "dna_derived_data.pcr_primer_name_forward": { "type": "keyword" },
      "dna_derived_data.pcr_primer_forward": { "type": "keyword", "index": false },
      "dna_derived_data.pcr_primer_name_reverse": { "type": "keyword" },
      "dna_derived_data.pcr_primer_reverse": { "type": "keyword", "index": false },
      ...
      "occurrence.dna_derived": { "type": "boolean" },
...
`occurrences-http-indicia.template` file to a new file called
