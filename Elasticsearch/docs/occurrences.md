...
PUT occurrence_brc1_v1
{
  ...
  "mappings": {
    ...
    "properties": {
      "id": { "type": "integer" },
      "@timestamp": { "type": "date"},
      "dna_derived_data.associated_sequences": { "type": "text" },
      "dna_derived_data.dna_sequence": { "type": "text" },
      "dna_derived_data.target_gene": { "type": "text" },
      "dna_derived_data.env_medium": { "type": "text" },
      "dna_derived_data.env_broad_scale": { "type": "text" },
      "dna_derived_data.otu_db": { "type": "text" },
      "dna_derived_data.otu_seq_comp_appr": { "type": "text" },
      "dna_derived_data.otu_class_appr": { "type": "text" },
      "dna_derived_data.dna_env_local_scale": { "type": "text" },
      "dna_derived_data.target_subfragment": { "type": "text" },
      "dna_derived_data.pcr_primer_name_forward": { "type": "text" },
      "dna_derived_data.pcr_primer_forward": { "type": "text" },
      "dna_derived_data.pcr_primer_name_reverse": { "type": "text" },
      "dna_derived_data.pcr_primer_reverse": { "type": "text" },
