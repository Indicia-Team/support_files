...
$custom_terms = array(
  ...
  '{1} type' => 'Project type',
  'Provide the full title of the {1}' => 'Provide the full title of the project',
  'Description and notes about the group which will be shown '
    . 'in the group listing pages to help other users find your group' => 
  'Description and notes about the project which will be shown '
    . 'in the project listing pages to help other users find your project',
  'What sort of {1} is it?' => 'What sort of project is it?',  
  'How users join this {1}}' =>
      'How users join this project',
  "group's" => "activity's",
  "groups" => "activities",
  ...
  'LANG_Record_Inclusion_Instruct_2' => 'If you choose to require records to '
    ...
    . 'records into the {1}.',
  'LANG_Description_Field_Instruct' => 'Description and notes about the project '
    . 'which will be shown in the project listing pages to help other users find '
    . 'your project.',
  ...
  'Thank you for submitting your {1} to {2}.' => 'Thank you for submitting your project to Plant Portal.'
);