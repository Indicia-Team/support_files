...
DECLARE
	...
	closed_attr_id		integer := 32; ---
	cms_userid_attr_id	integer := 18; ---
	cms_username_attr_id	integer := 19; ---
	flower_type_attr_id		integer := 5; ---
	habitat_attr_id		integer := 1; ---
	hive_attr_id		integer := 2; ---
	email_attr_id		integer := 8; ---
	start_time_attr_id		integer := 25; ---
	end_time_attr_id		integer := 26; ---
	sky_attr_id		integer := 36; ---
	shade_attr_id		integer := 39; ---
	temp_attr_id		integer := 37; ---
	wind_attr_id		integer := 38; ---
	insect_foraging_attr_id		integer := 7; ---
	insect_number_attr_id		integer := 6; ---
	---
...
BEGIN
	...
	LOOP
	  ...
	  BEGIN
		...
		cacherow.datedebut := (collectionrow.date_start::timestamp);
		cacheinsecttemplate1.datedebut := cacherow.datedebut;
		cacherow.datefin := (collectionrow.date_end::timestamp);
		cacheinsecttemplate1.datefin := cacherow.datefin;
