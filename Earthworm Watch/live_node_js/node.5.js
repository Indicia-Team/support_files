...
jQuery(document).ready(function($) {
  ...
  function default_ecosystem_type_in_add_mode() {
    $('#sc\\:adult-soil-0\\:\\:occAttr\\:538').val(6106);
    $('#sc\\:adult-soil-1\\:\\:occAttr\\:538').val(6107);
    $('#sc\\:adult-soil-2\\:\\:occAttr\\:538').val(6105);
    
    $('#sc\\:immature-soil-0\\:\\:occAttr\\:538').val(6106);
    $('#sc\\:immature-soil-1\\:\\:occAttr\\:538').val(6107);
    $('#sc\\:immature-soil-2\\:\\:occAttr\\:538').val(6105);
    
    $('#sc\\:adult-mustard-0\\:\\:occAttr\\:538').val(6106);
    $('#sc\\:adult-mustard-1\\:\\:occAttr\\:538').val(6107);
    $('#sc\\:adult-mustard-2\\:\\:occAttr\\:538').val(6105);
    
    $('#sc\\:immature-mustard-0\\:\\:occAttr\\:538').val(6106);
    $('#sc\\:immature-mustard-1\\:\\:occAttr\\:538').val(6107);
    $('#sc\\:immature-mustard-2\\:\\:occAttr\\:538').val(6105);
  }
});
