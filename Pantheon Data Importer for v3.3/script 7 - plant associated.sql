...
-- JVB made dynamic
--<termlist_id_for_plant_associated> with (select id from termlists where external_key='indicia:plant associated')
--<taxa_taxon_list_attribute_id_for_plant_associated> with (select id from taxa_taxon_list_attributes where caption='plant associated' and deleted=false)
--<taxa_taxon_list_attribute_id_for_vascular_plant_associated> with (select id from taxa_taxon_list_attributes where caption='vascular plant associated' and deleted=false)
--<taxa_taxon_list_attribute_id_for_inflorescence_associated> with (select id from taxa_taxon_list_attributes where caption='inflorescence associated' and deleted=false)
...
join indicia.termlists_terms itt on itt.termlist_id=(select id from termlists where external_key='indicia:plant associated') AND itt.term_id=iTerm.id AND itt.deleted=false
